...
echo "$($PSQL "SELECT SUM(winner_goals) + SUM(opponent_goals) AS tg FROM games")"
...
echo "$($PSQL "SELECT ROUND(AVG(winner_goals) + AVG(opponent_goals), 16) AS avg_g FROM games")"
